...
final class MoveNet: PoseEstimator {
  ...
  func estimateSinglePose(on pixelBuffer: CVPixelBuffer) throws -> (KPFrame, Times) {
  ...
  private func postprocess(imageSize: CGSize, modelOutput: Tensor) -> KPFrame? {
    ...
    return KPFrame(keyPoints: keyPoints, score: totalScore)
  }
